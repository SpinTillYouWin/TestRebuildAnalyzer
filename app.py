...
with gr.Blocks(title="WheelPulse by S.T.Y.W 📈") as demo:
    ...
    # Shepherd.js Tour Script (starting around line 5572, already in place)
    gr.HTML("""
    <script>
    ...
    # Remove duplicate JavaScript code from lines 5662 to 5703
    # (The duplicate code starting with "// Step 1: Header" has been removed)
