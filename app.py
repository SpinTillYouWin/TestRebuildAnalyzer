...
with gr.Blocks(title="WheelPulse by S.T.Y.W 📈") as demo:
    # T&C and Privacy Policy Modal (Shortened Version)
    gr.HTML("""
        <div class="modal-overlay" id="termsModal">
            <div class="modal-content">
                ...
                <div class="tab-content active" id="terms">
                    ...
                    <p>Welcome to WheelPulse by S.T.Y.W., an educational tool for analyzing roulette patterns. By using this app, you agree to these Terms and Conditions ("Terms"). If you do not agree, please do not use the app.</p>
                    <h3>1. Purpose and Use</h3>
                    <ul>
                        <li><strong>Educational Only</strong>: WheelPulse is for learning purposes only, analyzing spin data and strategies. It is not a gambling tool.</li>
                        <li><strong>No Gambling</strong>: Do not use the app for real-money gambling or betting. We are not responsible for any losses from such use.</li>
                    </ul>
                    <h3>2. Eligibility</h3>
                    <ul>
                        <li>You must be 19+ and in a jurisdiction where using this app for education is legal.</li>
                    </ul>
                    <h3>3. Intellectual Property</h3>
                    <ul>
                        <li>The app and its content are owned by S.T.Y.W. and protected by copyright laws. You may use it for personal, educational purposes only.</li>
                    </ul>
                    <h3>4. User Conduct</h3>
                    <ul>
                        <li>Do not use the app for illegal activities, gambling, or to disrupt its functionality.</li>
                    </ul>
                    <h3>5. Privacy</h3>
                    <ul>
                        <li>We protect your privacy. See our <a href="javascript:showTab('privacy')">Privacy Policy</a> for details.</li>
                    </ul>
                    <h3>6. No Gambling Advice</h3>
                    <ul>
                        <li>App outputs are for education only and not financial or gambling advice. Roulette outcomes are random, and we’re not liable for decisions based on app outputs.</li>
                    </ul>
                    <h3>7. Limitation of Liability</h3>
                    <ul>
                        <li>The app is provided "as is." We’re not liable for damages from misuse, including gambling losses. Our liability is limited to CAD $50.</li>
                    </ul>
                    <h3>8. Termination</h3>
                    <ul>
                ...
                <div class="tab-content" id="privacy">
                    ...
                    <p><strong>Last Updated: May 13, 2025</strong></p>
                    <p>We’re committed to your privacy. This Privacy Policy explains how we handle your information, per Canada’s <em>PIPEDA</em>.</p>
                    <h3>1. What We Collect</h3>
                    <ul>
                        <li><strong>Non-Personal Data</strong>: Spin history and inputs are stored locally on your device (via localStorage). We may collect anonymized usage data to improve the app.</li>
                        <li><strong>Personal Data</strong>: If you submit feedback, we collect your name and email (optional).</li>
                    </ul>
                    <h3>2. How We Use It</h3>
                    <ul>
                        <li>Provide app features (e.g., spin analysis).</li>
                        <li>Process feedback and improve the app.</li>
                        <li>Comply with legal requirements.</li>
                    </ul>
                    <h3>3. Sharing Information</h3>
                    <ul>
                        <li>We don’t sell your data. We may share feedback data with service providers (e.g., Formspree) or if required by law.</li>
                    </ul>
                    <h3>4. Storage and Security</h3>
                    <ul>
                        <li>Data is stored locally on your device. Feedback data is encrypted and retained for up to 12 months.</li>
                    </ul>
                    <h3>5. Your Rights</h3>
                    <ul>
                    ...
                    <ul>
                        <li>The app is not for users under 19. We don’t knowingly collect data from them.</li>
                    </ul>
                    <h3>8. Contact Us</h3>
                    <ul>
                        <li>Questions? Message us on our <a href="https://www.facebook.com/SpinTillYouWin" target="_blank">Spin Till You Win Facebook page</a>.</li>
