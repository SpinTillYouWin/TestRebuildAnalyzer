...
def select_next_spin_top_pick(last_spin_count):
    try:
        ...
        for num in range(37):
            hits = hit_counts[num]
            base_score = (hits / last_spin_count) * 15 if last_spin_count > 0 else 0
            even_money_score = 0
            ...
            total_score = round((base_score + even_money_score + dozen_column_score + wheel_side_score + hot_score + dominant_category_bonus), 2)
            scores.append((num, total_score, hits))
