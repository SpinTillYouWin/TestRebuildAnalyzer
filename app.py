        ...
        <div class="modal-overlay" id="termsModal">
            <div class="modal-content">
                ...
                <div class="full-text-links">
                    <button onclick="toggleFullText('terms')">View Full Terms and Conditions</button>
                    <button onclick="toggleFullText('privacy')">View Full Privacy Policy</button>
                </div>
                <!-- Full Terms -->
                <div class="full-text" id="terms" style="display: none;">
                    <h2>WheelPulse Terms and Conditions</h2>
                    <p><strong>Last Updated: May 13, 2025</strong></p>
                    <p>By using WheelPulse (the “App”), you agree to these Terms and Conditions (“Terms”), a legal agreement between you (“User”) and S.T.Y.W. (“Developer”) in Ontario, Canada. If you do not agree, do not use the App.</p>
                    <h3>1. Educational Purpose Only</h3>
                    <ul>
                        <li>WheelPulse is an educational tool for analyzing roulette patterns (e.g., spins, strategies, hot/cold numbers, betting progressions) for learning, not gambling.</li>
                        <li><strong>No Gambling</strong>: You must not use the App for real-money gambling, betting, or wagering. The Developer is not liable for any losses from such misuse.</li>
                        <li>Features include spin analysis, strategy simulations, betting progression tracking, hot/cold numbers, dealer’s spin tracker, casino data insights, and a feedback form.</li>
                    </ul>
                    <h3>2. Eligibility</h3>
                    <ul>
                        <li>You must be 19+ to use the App, aligning with Ontario’s casino gambling age, though the App is not for gambling.</li>
                        <li>Use must comply with local laws.</li>
                    </ul>
                    <h3>3. Intellectual Property</h3>
                    <ul>
                        <li>The App is owned by the Developer, protected by Canadian copyright laws. You have a limited license for personal, educational use only.</li>
                    </ul>
                    <h3>4. Prohibited Actions</h3>
                    <ul>
                        <li>Do not use the App for gambling, illegal activities, or to disrupt its functionality.</li>
                        <li>Do not misuse outputs (e.g., spin trends, strategies) to promote gambling.</li>
                    </ul>
                    <h3>5. Privacy</h3>
                    <ul>
                        <li>See our <a href="javascript:toggleFullText('privacy')">Privacy Policy</a> for how we handle your data (e.g., local spin data, optional feedback form).</li>
                    </ul>
                    <h3>6. No Advice or Liability</h3>
                    <ul>
                        <li>The App’s outputs (e.g., trends, strategies) are for education, not financial or gambling advice. Roulette outcomes are random.</li>
                        <li>The App is “as is.” The Developer is not liable for losses, damages, or issues from use or misuse, with liability capped at CAD $50.</li>
                    </ul>
                    <h3>7. Termination</h3>
                    <ul>
                        <li>We may suspend access if you violate these Terms. You may stop using the App anytime.</li>
                    </ul>
                    <h3>8. Governing Law</h3>
                    <ul>
                        <li>These Terms are governed by Ontario, Canada laws. Disputes are handled in Ontario courts.</li>
                    </ul>
                    <h3>9. Contact</h3>
                    <ul>
                        <li>Message us at <a href="https://www.facebook.com/SpinTillYouWin" target="_blank">Spin Till You Win</a> for questions.</li>
                    </ul>
                    <h3>10. Changes</h3>
                    <ul>
                    ...
                    <h3>Acceptance</h3>
                    <p>By checking “I agree” and clicking “I Agree,” you confirm you are 19+, understand these Terms and the <a href="javascript:toggleFullText('privacy')">Privacy Policy</a>, and will use the App only for education, not gambling.</p>
                </div>
                <!-- Full Privacy Policy -->
                <div class="full-text" id="privacy" style="display: none;">
                    <h2>WheelPulse Privacy Policy</h2>
                    <p><strong>Last Updated: May 13, 2025</strong></p>
                    <p>WheelPulse, developed by S.T.Y.W. in Ontario, Canada, values your privacy. This Privacy Policy, compliant with <em>PIPEDA</em>, explains how we handle your data. By using the App, you consent to these practices. If you disagree, do not use the App.</p>
                    <h3>1. Data We Collect</h3>
                    <ul>
                        <li><strong>Non-Personal Data</strong>: Spin history, casino data, and betting settings are stored locally on your device (localStorage/session memory), not on our servers.</li>
                        <li><strong>Personal Data</strong>: Optional feedback form may collect your name, email, and comments if you submit them.</li>
                        <li>No other personal data (e.g., location) is collected.</li>
                    </ul>
                    <h3>2. How We Use Data</h3>
                    <ul>
                        <li><strong>App Functionality</strong>: Local data powers educational features (e.g., spin trends, strategies).</li>
                        <li><strong>Feedback</strong>: Form data helps us respond to you or improve the App.</li>
                        <li><strong>Improvements</strong>: Anonymized usage data enhances the App.</li>
                    </ul>
                    <h3>3. Data Sharing</h3>
                    <ul>
                        <li>We do not sell or share personal data, except:
                            <ul>
                                <li>With form processors (e.g., Formspree) for feedback, under <em>PIPEDA</em> compliance.</li>
                                <li>If required by law (e.g., court order).</li>
                            </ul>
                        </li>
                        <li>Local data stays on your device unless submitted via feedback.</li>
                    </ul>
                    <h3>4. Security and Storage</h3>
                    <ul>
                        <li>Local data is deleted when you clear your browser cache.</li>
                        <li>Feedback data is encrypted (HTTPS) and kept up to 12 months, unless legally required.</li>
                        <li>We protect data but cannot guarantee against external threats (e.g., hacking).</li>
                    </ul>
                    <h3>5. Your Rights (<em>PIPEDA</em>)</h3>
                    <ul>
                        <li>Request access, correction, or deletion of your data, or withdraw consent, by messaging us.</li>
                        <li>Contact: <a href="https://www.facebook.com/SpinTillYouWin" target="_blank">Spin Till You Win</a>. We respond within 30 days.</li>
                    </ul>
                    <h3>6. No Cookies</h3>
                    <ul>
                        <li>We use localStorage, not cookies or trackers. Clear cache to reset data.</li>
                    </ul>
                    <h3>7. Children</h3>
                    <ul>
                        <li>The App is for users 19+. We do not collect data from those under 19.</li>
                    </ul>
                    <h3>8. International Use</h3>
                    <ul>
                        <li>Data is processed in Canada. Using the App outside Canada means you consent to this.</li>
                    </ul>
                    <h3>9. Updates</h3>
                    <ul>
                        <li>We may update this Policy. Continued use means acceptance.</li>
                    </ul>
                    <h3>10. Contact</h3>
                    <ul>
                        <li>Message us at <a href="https://www.facebook.com/SpinTillYouWin" target="_blank">Spin Till You Win</a>.</li>
                    </ul>
                    <h3>Acceptance</h3>
                    <p>By checking “I agree” and clicking “I Agree,” you consent to this Privacy Policy and the <a href="javascript:toggleFullText('terms')">Terms and Conditions</a>.</p>
                </div>
                <!-- Checkbox and Button -->
